      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex-1 flex items-center justify-between flex-wrap gap-3">
          <div>
            ...
            <p className="text-sm mt-0.5" style={{ color: 'var(--text-muted)' }}>{candidate?.email}</p>
          </div>
                ...
                {candidate?.skills?.length > 0 && (
                  <div className="pt-3" style={{ borderTop: '1px solid var(--border)' }}>
                    <p className="text-xs font-semibold uppercase tracking-wide mb-2"
                      style={{ color: 'var(--text-muted)' }}>Skills</p>
        ...
        <div className="xl:col-span-2 space-y-5">
          ...
          <div className="glass p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm" style={{ color: 'var(--text-muted)' }}>Final Weighted Score</p>
                    ...
                    >
                      <div className="flex items-center justify-between mb-3">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          />
                          <span className="text-sm" style={{ color: 'var(--text-muted)' }}>/{round.maxScore}</span>
                        </div>
                      </div>
                      ...
                      <div className="flex justify-between mt-1">
                        <span className="text-xs"
                          style={{ color: isBelowCutoff ? '#ef4444' : 'var(--text-muted)' }}>
