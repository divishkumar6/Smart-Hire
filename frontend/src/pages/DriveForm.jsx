    ...
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-[var(--text-muted)] mt-0.5">Configure your recruitment drive</p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="glass p-6 space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              ...
              <p className="text-xs text-[var(--text-muted)] mt-1">Candidates above this score get selected</p>
            </div>
            <div>
              ...
              <p className="text-xs text-[var(--text-muted)] mt-1">Candidates above this get waitlisted</p>
            </div>
          </div>
        </div>
        ...
        <div className="glass p-6 space-y-4">
          ...
          <p className="text-xs" style={{ color: 'var(--text-muted)' }}>Used when generating offer letters for selected candidates</p>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
        ...
        <div className="glass p-6 space-y-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xs text-[var(--text-muted)] mt-0.5">Total weightage must equal 100%</p>
            </div>
          ...
          <div className="space-y-3">
            {form.rounds.map((round, idx) => (
              <motion.div
                ...
                className="p-4 rounded-xl bg-[var(--bg-card)] border border-white/10"
              >
                <div className="flex items-center gap-2 mb-3">
                  <span className="w-6 h-6 rounded-full bg-primary-600/30 text-primary-400 text-xs flex items-center justify-center font-bold">
                    {idx + 1}
                  </span>
                  <input
                    value={round.name}
