    ...
    <div className="max-w-2xl mx-auto space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-sm mt-0.5" style={{ color: 'var(--text-muted)' }}>Register a new candidate to a drive</p>
        </div>
      </div>
      <form onSubmit={handleSubmit} className="glass p-8 space-y-5">
        ...
        <div>
          ...
          <p className="text-xs mt-1.5" style={{ color: 'var(--text-muted)' }}>Press Enter or click + to add. Skills are used for ATS scoring.</p>
        </div>
        <div>
